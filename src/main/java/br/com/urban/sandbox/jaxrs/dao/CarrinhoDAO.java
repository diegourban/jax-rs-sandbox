package br.com.urban.sandbox.jaxrs.dao;
...
public class CarrinhoDAO {
	...
	static {
		...
		Carrinho carrinho = new Carrinho().adiciona(videogame).adiciona(esporte)
				.para("Rua Vergueiro 3185, 8 andar", "São Paulo").setId(1l);
